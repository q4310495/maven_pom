...
<head>
    ...
    <script type="text/javascript">
                    ...
                    switch(message.messageType){
                        case RongIMClient.MessageType.TextMessage:
                            ...
                            if(toid == message.senderUserId){
                                ...
                                $("#toMsgdiv").append(toname + " " +  time + "<br/> " + content + "<br/><br/>");
        ...
        function openDialog() {
            ...
            $.ajax({
                ...
                success:function (data) {
                    $("#fridenddiv").append("<ul>");
                    for (var i=0;i<data.length; i++){
                        $("#frienddiv_id").append("<li><a id='user_" + data[i].id + "' ondblclick='openMsgDialog(" + data[i].id + ", \"" + data[i].name + "\");'>" + data[i].name + "</a></li>");
                    }
                    $("#fridenddiv").append("</ul>")
        ...
        function sendMsg() {
            ...
            $("#content").val("");
            var time=new Date().getFullYear()+"-"+(new Date().getMonth()+1)+"-"+new Date().getDate();
            $("#toMsgdiv").append("${emp.name}"+time+":<br/>"+content+"<br/><br/>");
...
<div id="body-wrapper">
    ...
    <div id="sidebar">
        <div id="sidebar-wrapper">
            ...
            <div id="frienddiv_id" style="display: none;">
                <div id="fridenddiv"></div>
            </div>
            <div id="toMsg_div" style="display: none;">
            ...
            <ul id="main-nav">
                ...
                <%--<li><a class="nav-top-item"> 组织管理 </a>
                    <ul>
                        ...
                        <li><a onclick="itemclick(this);" name="emp/queryAll">职工管理</a></li>
                        <li><a onclick="itemclick(this);" name="role/queryAll">角色管理</a></li>
                        <li><a onclick="itemclick(this);" name="resc/queryAll">权限管理</a></li>
                    </ul>
                </li>--%>
